...
route.put("/update-user-email-notification",authMiddleware,asyncHandler(UserController.updateUserEmailNotification));
route.delete("/delete-user/:user-id",asyncHandler(UserController.deleteUser));
