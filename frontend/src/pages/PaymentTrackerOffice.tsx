...
import { Plus, Edit2, Trash2, X, CheckCircle, AlertTriangle, Clock, Filter, Mail } from 'lucide-react';
...
const PaymentTrackerOffice: React.FC = () => {
  ...
  const [dateFilter, setDateFilter] = useState<'all' | 'today' | 'last7days' | 'last30days' | 'lastyear' | 'custom'>('all');
    ...
    <div className="">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <button onClick={() => setShowEmailModal(true)} className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg transition-colors flex items-center gap-2">
            <Mail size={20} />
            Send Email
          </button>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <select value={dateFilter} onChange={(e) => setDateFilter(e.target.value as any)} className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
          ...
          {dateFilter === 'custom' && (
            <>
              <input type="date" value={customStartDate} onChange={(e) => setCustomStartDate(e.target.value)} className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Start Date" />
              <input type="date" value={customEndDate} onChange={(e) => setCustomEndDate(e.target.value)} className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="End Date" />
            </>
          )}
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2 justify-end">
                ...
                <button onClick={handleSendEmail} className="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600">
                  Send Email
                </button>
              </div>
            </div>
